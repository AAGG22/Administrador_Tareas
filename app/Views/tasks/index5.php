                ...
                <h2 class="accordion-header" id="heading<?= $task['id'] ?>">
                    <button class="accordion-button accordion-toggle <?= $index === 0 ? '' : 'collapsed' ?>" 
                        ...
                        <div class="d-flex justify-content-between w-100 align-items-center">
                            ...
                            <div>
                                <a href="<?= site_url("tasks/edit/{$task['id']}") ?>" class="btn btn-sm btn-outline-warning me-2">Editar</a>
                            ...
                            <ul class="list-group">
                                <?php foreach ($task['subtasks'] as $subtask): ?>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="<?= site_url("tasks/editSubtask/{$subtask['id']}") ?>" class="btn btn-sm btn-outline-warning me-2">Editar</a>
