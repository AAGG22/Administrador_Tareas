...
<head>
    <meta charset="UTF-8">
    <title>Buenvenido a CodeIgniter 4!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Bienvenido a CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?> <br>Soy Alfredo y te estoy cachando</h1>

        <h2>The small framework with powerful features</h2>
        <h2>El pequeño framework con potentes funciones</h2>
